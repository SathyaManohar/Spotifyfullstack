...
<p className='font-bold'>Search</p>
      ...
      <div className='bg-[#121212] h-[85%] rounded'>
        ...
        <div className='p-4 bg-[#121212] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4'>
            ...
            <button onClick={()=>navigate('/')} className='px-4 py-1.5 bg-white text-[15px] text-black rounded-full mt-4'>Create Playlist</button>
        </div>

        <div className='p-4 bg-[#121212] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4 mt-5'>
